...
const errorExchange: Exchange = ({ forward }) => (ops$) => {
  return pipe(
    ...
    tap(({ error }) => {
      ...
      // If the OperationResult ahs an error send a request to sentry
      // if (error) {
      //   // the error si a CombinedError with networkError and graphqlErrors properties
